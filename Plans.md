...
| 19.3 | Replay scrubber ("demo as video"): re-sim-from-tic-0 ONLY (keyframes = decision-gated follow-up); measured seek latency cited (15.5: ~100× realtime → worst-case 44,580-tic seek ≈ 13 s, stated in UI); input timeline strip under the scrubber | scrub-to-N full-trace hash == linear-playback-at-N; seek latency measured on wbox | 19.2 | cc:TODO |
