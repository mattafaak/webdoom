...
| perf-012 | perf.md:134 | peak heap address worst-case single IWAD | ~22.06 MB | derived | 1,512,336 + 4,194,304 + 17,420,824 = 23,127,464 B ≈ 22.06 MB | derived-from-gated |
| perf-013 | perf.md:135 | headroom vs 32 MB (single IWAD) | ~9.94 MB | derived | 33,554,432 − 23,127,464 = 10,426,968 B ≈ 9.94 MB | derived-from-gated |
...
| perf-015 | perf.md:212 | all deliverables total gzip-9 wire size | 201.9 KB | measurement | tools/payload-size.mjs (derived from sw.js SHELL_FILES) | verified |
| perf-016 | perf.md:213 | JS + CSS + HTML gzip-9 total (no wasm, no glue) | 68.2 KB | measurement | tools/payload-size.mjs (derived from sw.js SHELL_FILES) | verified |
