...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `b16407701c676f52976344f339790556` (re-proven after redesign). Size 357,267 bytes. |
| **toggle-on build** | `build-fakeflat/doom.wasm` md5 = `89b3195f7ac0f78150509fffb1cbd394`. Size 355,523 bytes (budget: 360,448 bytes → green; smaller than first attempt due to removed threshold code). Built with `EXTRA_CFLAGS=-DWEBDOOM_FAKEFLAT BUILD=../build-fakeflat`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `b16407701c676f52976344f339790556` (proven). Size 357,267 bytes. |
| **toggle-on build** | `build-sbskip/doom.wasm` md5 = `01aeacaa52104f1ce9f78318f12b7c49`. Size 358,083 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_SBSKIP BUILD=../build-sbskip`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `b16407701c676f52976344f339790556` (proven). Size 357,267 bytes. |
| **toggle-on build** | `build-potato/doom.wasm` md5 = `8fa650a2e5930ea9f332097d1807a024`. Size 358,174 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_POTATO BUILD=../build-potato`. |
