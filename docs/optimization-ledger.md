...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `3edea657b5a54395613fef9cd2dbc539` (re-proven after redesign). Size 357,101 bytes. |
| **toggle-on build** | `build-fakeflat/doom.wasm` md5 = `58ff410422c6456ef5d874a7238ec3f7`. Size 355,353 bytes (budget: 360,448 bytes → green; smaller than first attempt due to removed threshold code). Built with `EXTRA_CFLAGS=-DWEBDOOM_FAKEFLAT BUILD=../build-fakeflat`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `3edea657b5a54395613fef9cd2dbc539` (proven). Size 357,101 bytes. |
| **toggle-on build** | `build-sbskip/doom.wasm` md5 = `8fe2ac1a9cf881ce13d954e4bd75d8d8`. Size 357,917 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_SBSKIP BUILD=../build-sbskip`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `3edea657b5a54395613fef9cd2dbc539` (proven). Size 357,101 bytes. |
| **toggle-on build** | `build-potato/doom.wasm` md5 = `facd971de2d8652646728c55f8fbad5e`. Size 357,999 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_POTATO BUILD=../build-potato`. |
