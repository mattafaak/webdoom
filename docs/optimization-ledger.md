...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `a1109b9c2ad9c04374767cce8dd51712` (re-proven after redesign). Size 355,893 bytes. |
| **toggle-on build** | `build-fakeflat/doom.wasm` md5 = `22372e0b2a3df73bc86bd88a60545c8e`. Size 354,133 bytes (budget: 360,448 bytes → green; smaller than first attempt due to removed threshold code). Built with `EXTRA_CFLAGS=-DWEBDOOM_FAKEFLAT BUILD=../build-fakeflat`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `a1109b9c2ad9c04374767cce8dd51712` (proven). Size 355,893 bytes. |
| **toggle-on build** | `build-sbskip/doom.wasm` md5 = `c24f785b90c5c833c271523a5643a72c`. Size 356,703 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_SBSKIP BUILD=../build-sbskip`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `a1109b9c2ad9c04374767cce8dd51712` (proven). Size 355,893 bytes. |
| **toggle-on build** | `build-potato/doom.wasm` md5 = `be1b26ef7a9bc720b97a2024004e764b`. Size 356,811 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_POTATO BUILD=../build-potato`. |
