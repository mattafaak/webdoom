...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `fbc3137aa6adb6b24450734013ee02ad` (re-proven after redesign). Size 356,693 bytes. |
| **toggle-on build** | `build-fakeflat/doom.wasm` md5 = `692a662080b45462da4c2d6efdef9882`. Size 354,949 bytes (budget: 360,448 bytes → green; smaller than first attempt due to removed threshold code). Built with `EXTRA_CFLAGS=-DWEBDOOM_FAKEFLAT BUILD=../build-fakeflat`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `fbc3137aa6adb6b24450734013ee02ad` (proven). Size 356,693 bytes. |
| **toggle-on build** | `build-sbskip/doom.wasm` md5 = `e4e1a205f20ec6c5490e8942d5c1e0de`. Size 357,508 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_SBSKIP BUILD=../build-sbskip`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `fbc3137aa6adb6b24450734013ee02ad` (proven). Size 356,693 bytes. |
| **toggle-on build** | `build-potato/doom.wasm` md5 = `4c2383062a1c78c62f47574c4e4ea4e9`. Size 357,596 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_POTATO BUILD=../build-potato`. |
