...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `f0c2bfde6289f319e40d306d730c1481` (re-proven after redesign). Size 357,034 bytes. |
| **toggle-on build** | `build-fakeflat/doom.wasm` md5 = `fb45aa64c68ef16921094c80a813ecf1`. Size 355,290 bytes (budget: 360,448 bytes → green; smaller than first attempt due to removed threshold code). Built with `EXTRA_CFLAGS=-DWEBDOOM_FAKEFLAT BUILD=../build-fakeflat`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `f0c2bfde6289f319e40d306d730c1481` (proven). Size 357,034 bytes. |
| **toggle-on build** | `build-sbskip/doom.wasm` md5 = `76bc63afe9c5af94456245c848eef016`. Size 357,849 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_SBSKIP BUILD=../build-sbskip`. |
...
| **toggle-off byte-identity** | `build/doom.wasm` md5 = `f0c2bfde6289f319e40d306d730c1481` (proven). Size 357,034 bytes. |
| **toggle-on build** | `build-potato/doom.wasm` md5 = `513c172d65e2131ac879e6d139d5115d`. Size 357,937 bytes (budget: 360,448 bytes → green). Built with `EXTRA_CFLAGS=-DWEBDOOM_POTATO BUILD=../build-potato`. |
