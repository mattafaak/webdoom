...
| rme-008 | README:22–24 | "Server carries the WAD library (Ultimate Doom, Doom II, Final Doom, SIGIL, Master Levels, NRFTL, Chex Quest)" | **FLAGGED(demo gates cover only 4 demo-bearing IWADs; SIGIL, Master Levels, NRFTL and Chex have no automated smoke test — 15.3. HACX was listed here and in README until this pass and was never servable: absent from the manifest and refused by wad-import.js. That half was not an untested promise, it was a false one; `tools/check-menu-reachable.mjs` now gates the class)** |
