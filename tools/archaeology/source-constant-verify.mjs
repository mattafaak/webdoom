...
function grabDefine(file, name) {
    ...
    // SCREENWIDTH must be substituted before
...
const claims = [
    ...
    { id: 'rdr-004', desc: 'MAXOPENINGS webdoom (SCREENWIDTH×64) = 20480 (vanilla ×64 ratio per 14.2f; the 854 cap went with widescreen)',
      expected: 20480,
