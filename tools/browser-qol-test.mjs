...
const EXPECTED_STAGES = ['1', '2', '3', '4', '5', '6', '7'];
...
console.log(`PASS — browser-qol: ${STAGES.size} of ${EXPECTED_STAGES.length} stages verified (default-off, settings checkboxes, feature-on, stats text, persist-after-reload, feature-off, localStorage keys)`);
cleanup(0);
